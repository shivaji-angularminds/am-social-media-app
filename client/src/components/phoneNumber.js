...
const PhoneNumber = ({phone, setPhone}) => {
	...
	const [flagImg,setFlagImg]=useState(PhoneIcon);
    
	const selectCountryHandler = (e) => {
		console.log(setCountryCodeValue(e.target.value));
	...
	const countryFlagHandler = () => {
		const select = document.querySelector('#country');
			setFlagImg(`https://flagpedia.net/data/flags/h80/${select.selectedOptions[0].dataset.countrycode.toLowerCase()}.webp`)
